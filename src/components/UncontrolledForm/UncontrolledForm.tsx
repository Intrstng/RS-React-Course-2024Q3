...
//           <input type="text" id="name" name="name" className={S.formInput} autoComplete="name"/>
//           {errors?.name && <CustomError error={errors.name} />}
//         </div>
//         <div className={S.formGroup}>
//           <label htmlFor="age">Age</label>
//           <input type="number" id="age" name="age" className={S.formInput} autoComplete="age"/>
//           {errors?.age && <CustomError error={errors.age} />}
//         </div>
//         <div className={S.formGroup}>
//           <label htmlFor="email">Email</label>
//           <input type="email" id="email" name="email" className={S.formInput} autoComplete="email"/>
...
// // SECOND VARIANT: WITH LIVE RESET ERRORS IN INPUTS
  ...
  return (
      <div className={S.formContainer}>
        ...
        <form ref={formRef} onSubmit={formSubmitHandler}>
          ...
          <UncontrolledSearchBar error={errors?.country} countries={countries} resetError={resetInputCountryError}/>
          <button type="submit" className={S.submitButton}>
            Submit
          </button>
        </form>
